...
int main(int argc, char *argv[])
{
     ...
     * This code runs from MN area however the proxy is in another country
     * 
     ...
     *   Connected!
     *   Sending
     *   encryptedBytesWritten:  517
     *   peerVerifyError:  "The issuer certificate of a locally looked up certificate could not be found"
     *   peerVerifyError:  "No certificates could be verified"
     *   SSL Errors!
     *   "The issuer certificate of a locally looked up certificate could not be found"
     *   "No certificates could be verified"
     *   Error: QAbstractSocket::SocketError(13)   "The issuer certificate of a locally looked up certificate could not be found"
     *   State:  ClosingState
