...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
    ...
    auto trackerS = new G4Tubs("tracker", 
                               0, 
                               trackerSize, 
                               trackerSize, 
                               0.0 * deg, 360. * deg);

    auto trackerLV = new G4LogicalVolume(trackerS, 
                                         fWorldMaterial, 
                                         "Tracker", 
                                         nullptr, 
                                         nullptr, 
    ...
    auto boxVisAtt = new G4VisAttributes(G4Colour(1.0, 
                                                  1.0, 
                                                  1.0));
    
    auto chamberVisAtt = new G4VisAttributes(G4Colour(1.0, 
                                                      1.0, 
                                                      0.0));
  ...
  for (G4int copyNo=0; copyNo<fNbOfChambers; copyNo++) 
  {
      ...
      fLogicChamber[copyNo] = new G4LogicalVolume(chamberS, 
                                                  fChamberMaterial, 
                                                  "Chamber_LV", 
                                                  nullptr, 
                                                  nullptr, 
...
{
  // Sensitive detectors.  The class TrackerSD is initialized in the ConstructSDandField method.
  ...
  // of "Chamber_LV".
  SetSensitiveDetector("Chamber_LV", 
                       aTrackerSD, 
                       true);
...
void DetectorConstruction::SetChamberMaterial(G4String materialName)
{
  ...
  if (fChamberMaterial != pttoMaterial) 
  {
      ...
      {
          G4cout        << G4endl
            << "-->  WARNING from SetChamberMaterial : " << materialName << " not found" << G4endl;
      }
  }
}
