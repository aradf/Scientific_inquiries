...
int main( int argc, char** argv )
{
   ...
   // load image
   const std::vector< float > image_vector = loadImage( image_file );
   ...
   // Define shape.
   const std::array< int64_t, 4 > input_shape = { 1, number_channels, height, width };
   ...
   std::sort( index_valuePairs.begin(), index_valuePairs.end(), [](const auto& lhs, const auto& rhs) { return lhs.second > rhs.second; });
