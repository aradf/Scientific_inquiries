...
# image_BGR = cv2.imread('images/woman-working-in-the-office-1.png')
# image_BGR = cv2.imread('images/woman-working-in-the-office-2.jpeg')
...
blob = cv2.dnn.blobFromImage( image_BGR, 
                              1/255.0, 
                              (416, 416),
                              swapRB=True, 
                              crop=False)
