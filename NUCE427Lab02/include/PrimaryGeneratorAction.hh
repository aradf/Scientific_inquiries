...
// ********************************************************************
#ifndef NUCE427LAB02PrimaryGeneratorAction_h
#define NUCE427LAB02PrimaryGeneratorAction_h 1
...
class PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    ...
    const G4ParticleGun* get_particleGun() const { return current_particle_gun; }

  private:
    G4ParticleGun* current_particle_gun;
};
