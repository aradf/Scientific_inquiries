...
def main():
    ...
    for epoch in range(1, n_epochs + 1):
        train_losses_out, train_counter_out = train(epoch, 
                                                    network, 
                                                    train_loader, 
                                                    optimizer, 
                                                    log_interval, 
                                                    train_losses, 
                                                    train_counter)
        test_losses_out = test(network, test_loader, test_losses)

    fig = plt.figure()
    plt.plot(train_counter_out, train_losses_out, color='blue')
    plt.scatter(test_counter, test_losses_out, color='red')
