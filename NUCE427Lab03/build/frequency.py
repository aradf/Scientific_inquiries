...
def plot_rawData():
    ...
    plt.hist(d1_float, bins=100)
    plt.xlim([1,4])

    plt.xlabel("Energy (MeV)")
    plt.ylabel("Theraml Neutron Count")
    plt.title("Primary particle Energy Deposit in 'BF3' \n due to 0.25 eV Neutron Simualted by Geant4")
    plt.savefig('histogram.png')
    plt.close()
